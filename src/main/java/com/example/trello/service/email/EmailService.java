package com.example.trello.service.email;
...
public class EmailService implements EmailSender {
    ...
    public void send(String to, String email) {
        try {
            ...
            helper.setFrom("thanhlonghoangdao1101@gmail.com");
    ...
    public String buildActiveEmail(String name, String otp, Long id) {
        String link = "https://trello-like-vip.herokuapp.com/api/auth" + Constants.Api.Path.Account.ACTIVE_ACCOUNT + "?otp=" + otp + "&id=" + id;
